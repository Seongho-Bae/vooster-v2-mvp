...
```json
{
  ...
  "data": {
    "key": "VSPEC-001",
    "path": "specs/usecases/VSPEC-001-author-a-use-case.md",
    "format": "BRIEF"
  },
  ...
  "suggested_next_actions": [
    {
      "command": "vspec usecase apply VSPEC-001 --section main-success",
      "reason": "Author the main success steps (pipe the numbered list via stdin)."
    },
    {
      "command": "vspec doctor VSPEC-001",
