...
function validateScenarioSteps(
  findings: Finding[],
  useCase: ParsedUseCase,
  actors: EntityIndex,
  glossary: Glossary,
...
function validateUseCaseQuality(
  findings: Finding[],
  useCase: ParsedUseCase,
  glossary: Glossary,
  location: string,
...
function validateUseCase(args: {
  ...
  validateBasicFormat(findings, useCase, location);
  validateScenarioSteps(findings, useCase, actors, glossary, location);
  validateEntities(findings, useCase, actors, stakeholders, location);
  validateExtensions(findings, useCase, location);
  validateUseCaseQuality(findings, useCase, glossary, location);
  validateRequiredFields(findings, useCase, location);
