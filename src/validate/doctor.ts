...
function validateUseCase(args: {
  ...
  validateBasicStructure(findings, useCase, actors, stakeholders, location);
  validateMainSuccessScenario(findings, useCase, actors, glossary, location);
  validateExtensionsScenario(findings, useCase, actors, glossary, location);
...
function validateMainSuccessScenario(
  findings: Finding[],
  useCase: ParsedUseCase,
  actors: EntityIndex,
  glossary: Glossary,
...
function validateExtensionsScenario(
  findings: Finding[],
  useCase: ParsedUseCase,
  actors: EntityIndex,
  glossary: Glossary,
